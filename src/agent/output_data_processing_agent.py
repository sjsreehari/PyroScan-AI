...
from src.agent.prompt import OutputRawDataProcessorPrompt  # Ensure this returns proper prompt string
...
def final_output_data_processing_agent():
    ...
    # Prepare prompt
    prompt = OutputRawDataProcessorPrompt.format_prompt(raw_data)  
